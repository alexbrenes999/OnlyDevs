...
export default function Profile () {
    return (
        <div>
            ...
            <div class="relative w-full group max-w-md min-w-0 mx-auto mt-16 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-xl rounded-xl">
                <div class="pb-6">
                    ...
                    <div class="pt-6 mx-6 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
                        <div class="flex flex-wrap justify-center">
                            <div class="w-full px-6">
                                <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Qualifications</h3>
                            ...
                            <div class="w-full px-6">
                                <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Publications</h3>
                                <p class="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                                </p>
                            </div>
                            <div class="w-full px-6">
                                <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Activity Status</h3>
                                <p class="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                                    HIGH!
                                </p>
                            </div>
                    ...
                    <div class="pt-6 mx-6 mt-6 text-center border-t border-gray-200 dark:border-gray-700/50">
                    <div class="w-full px-6">
                                <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Contact</h3>
                                <p class="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
